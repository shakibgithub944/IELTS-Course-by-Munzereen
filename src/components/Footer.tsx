      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <a href="tel:16910" className="text-gray-300 hover:text-white transition-colors">
                  {lang === 'en' ? 'Call: 16910' : 'কল: ১৬৯১০'}
                </a>
              </li>
              <li>
                <a href="mailto:support@10minuteschool.com" className="text-gray-300 hover:text-white transition-colors">
        ...
        <div className="border-t border-gray-800 mt-8 pt-8 flex flex-col md:flex-row justify-between items-center">
          <p className="text-gray-400 text-sm">
            © 2024 10 Minute School. {lang === 'en' ? 'All rights reserved.' : 'সকল অধিকার সংরক্ষিত।'}
          </p>
