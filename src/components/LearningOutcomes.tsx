...
export default function LearningOutcomes({
  ...
  if (section.type !== "pointers" || !section?.values?.length) return null;
    ...
    <section className="py-16 bg-gradient-to-br from-green-50 to-blue-50">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid md:grid-cols-2 gap-6">
          {section.values.map((pointer: any, index) => (
        ...
        <div className="mt-16 bg-white rounded-2xl shadow-lg p-8">
          ...
          <div className="grid md:grid-cols-3 gap-6">
            <div className="text-center">
              <div className="w-16 h-16 bg-blue-100 text-[#1eaa55] rounded-full flex items-center justify-center mx-auto mb-4">
                <svg
                  className="w-8 h-8"
                  fill="currentColor"
                  viewBox="0 0 20 20"
