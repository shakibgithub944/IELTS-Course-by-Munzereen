...
export default function FAQ({ section, lang }: FAQProps) {
  ...
  if (section.type !== "faq" || !section?.values?.length) return null;
    ...
    <section className="py-16 bg-white">
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-4">
          {section?.values?.map((faq: any, index) => (
            <div
              key={index}
        ...
        <div className="mt-12 text-center">
          <div className="bg-blue-50 rounded-lg p-6">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center">
              <a
                href="tel:16910"
                className="inline-flex items-center justify-center px-4 py-2 border border-[#1eaa55] text-[#1eaa55] rounded-md hover:bg-blue-50 transition-colors"
              >
                <svg
              ...
              <a
                ...
                className="inline-flex items-center justify-center px-4 py-2 bg-[#1eaa55] text-white rounded-md hover:bg-[#1eaa55] transition-colors"
              >
                <svg
                  className="w-4 h-4 mr-2"
                  fill="currentColor"
