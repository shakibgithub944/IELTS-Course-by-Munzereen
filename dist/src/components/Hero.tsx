...
export default function Hero({ data, lang }: HeroProps) {
  ...
  return (
    <section className="bg-gradient-to-br from-[#022335] via-[#022335] to-[#010a11] text-white h-screen">
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            <div>
              ...
              <div className="flex items-center space-x-2 mb-6">
                ...
                <span className="text-sm opacity-90">
                  (82.6%{" "}
                  {lang === "en"
                    ? "students got their desired band score"
                    : "শিক্ষার্থী কাঙ্ক্ষিত ব্যান্ড স্কোর পেয়েছেন"}
                  )
                </span>
              </div>
            ...
            <div className="space-y-4">
              ...
              <button className="bg-[#1eaa55] hover:bg-[#1eaa55]/80 text-white font-semibold px-8 py-4 rounded-lg text-lg transition-colors w-full sm:w-auto">
                {lang === "en" ? "Enroll Now" : "এখন অনরোল করুন"}
              </button>
            </div>
